%% Cropping script gen for single mouse brain with 3 sections/slide
% Samik Banerjee Aug 18, 2022
% crop_mouse_single<int>nz, <string>brainID, <string>prefix)
% nz --> NanoZomer Number (1/2/3)
% Usage: crop_mouse_single(1, 'MD928', 'MD')
% OP: in cwd .
%     MD928.sh
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% addpath(genpath('ngr2tif'));

function crop_mouse_single(nz, brainID, prefix)
%     prefix = 'MD';
%     nz = 3;
%     brainID = 'MD928';
